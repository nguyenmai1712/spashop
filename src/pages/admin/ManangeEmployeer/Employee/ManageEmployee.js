import { Button, Dialog, InputAdornment, makeStyles, MenuItem, Select, TextField } from '@material-ui/core';
...
const DATA_TABLE_TYPE = "EMPLOYEE";
...
function ManageEmployee(props) {
    ...
    return (
        <div>
            ...
            <div>
            <Dialog onClose={()=> setOpenModal(false)} aria-labelledby="customized-dialog-title" open={isOpenModal}>
                <EmployeeModal
